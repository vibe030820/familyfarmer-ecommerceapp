...
// import 'package:ecommerce_app/widget/app_constant.dart';
...
Future<void> main() async {
  if (kIsWeb) {
    ...
    // If the platform is web, run the web-specific entry point
    runApp(MyApp());
  } else {
    WidgetsFlutterBinding.ensureInitialized();
    await Firebase.initializeApp(
    ...
    // For other platforms, run the regular entry point
    runApp(MyApp());
  }
}
